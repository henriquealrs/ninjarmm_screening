...
T checkIfPositive(const U& u, const int& param1, const int& param2, int param3 = 0, std::optional<std::reference_wrapper<int>> total = std::nullopt)
{
